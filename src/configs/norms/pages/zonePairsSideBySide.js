...
export const zonePairsSideBySide = {
      ...
      config: {
        ...
        filters: [
          ...
          { ...selectors.scenarioCodeFilter, filterName: "Left Scenario", visualisations: ['Zone Pairs Side-by-Side'], actions: [{ action: "UPDATE_DUAL_QUERY_PARAMS" }] },
          ...
          { ...selectors.scenarioCodeFilter, filterName: "Right Scenario", visualisations: ['Zone Pairs Side-by-Side'], actions: [{ action: "UPDATE_DUAL_QUERY_PARAMS" }]},
