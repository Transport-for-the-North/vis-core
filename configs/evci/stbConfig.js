...
export const stbConfig = [
  {
    ...
    pages: ['tfnEvUptake','tfnAnnualChargingDemand','tfnEvcpRequirements', 'tfnCo2Savings', 'potentialChargingSites', 'enrouteChargingSites','cpArea','cpLocation','cpMajorRoad'],
  ...
  },
  {
    ...
    pages: ['evUptake','annualChargingDemand','evcpRequirements','potentialChargingSites', 'enrouteChargingSites'],
    termsOfUseText: "Welcome",
