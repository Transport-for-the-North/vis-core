    ...
    additionalFeatures: {
      ...
      download: {
        filters: [
          ...
          { ...selectors.siteDownloadSelector, actions: [{action: 'SET_SELECTED_FEATURES'}] }
        ],
...
export const eehPotentialChargingSites = {
  ...potentialChargingSites,
  about: `
  <p>Shows the sites within a region with the most potential for the installation of en-route charging infrastructure. 
  This ranking is not designed to provide users with specific parcels of land for development but is instead designed to show 
...
<p>Sites are expressed relative to the single best scored site in the TfN area. Only sites meeting a minimum threshold have been included. Each point represents a hexagonal cell of side length 620 metres, centred on the point shown.</p>
  ...
  config: {
    ...
    additionalFeatures: {
      ...
      warning: `
  Locations shown are not specific parcels of land for development, but intended to show broader regions where rapid charging hub development looks promising.           
  To note- the STB EVCI Framework for the England's Economic Heartland is being updated to reflect the new unitary authority boundaries for Buckinghamshire and Northamptonshire. This will be available early in 2025. Multiple local authority zones can be selected on the tool to create a total output for these areas.`,
    },
  },
};
