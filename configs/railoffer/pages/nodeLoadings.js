...
export const nodeLoadings = {
  ...
  config: {
    ...
    filters: [
        ...
        { ...selectors.nodeTOCSelector, visualisations: ['Node Loading Totals'] },
        { ...selectors.booleanSelector, visualisations: ['Node Loading Totals'], filterName: "Strategic Rail Station", paramName: "stratRailNorth" },
        { ...selectors.booleanSelector, visualisations: ['Node Loading Totals'], filterName: "NPR Station", paramName: "nprNorth" },
