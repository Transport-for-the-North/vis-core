...
export const nodeLoadings = {
  ...
  config: {
    ...
    filters: [
        ...
        { ...selectors.nodeTOCSelector, visualisations: ['Node Loading Totals'], multiSelect: true},
        { ...selectors.booleanSelector, visualisations: ['Node Loading Totals'], multiSelect: true, filterName: "Strategic Rail Station", paramName: "stratRailNorth" },
        { ...selectors.booleanSelector, visualisations: ['Node Loading Totals'], multiSelect: true, filterName: "NPR Station", paramName: "nprNorth" },
        // { ...selectors.routeNameSelector, multiSelect: true, visualisations: ['Node Loading Totals'] },
