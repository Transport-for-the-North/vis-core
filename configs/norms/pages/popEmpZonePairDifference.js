...
export const popEmpZonePairDifference = {
      ...
      config: {
        ...
        filters: [ 
            ...
            { ...selectors.timePeriod, filterName: "Time Period 1", visualisations:['Landuse Accessibility Pair Difference'],
              shouldBeBlankOnInit: false,
              multiSelect: true,
              isClearable: true,
            },
            { ...selectors.timePeriodTwo, filterName: "Time Period 2", visualisations:['Landuse Accessibility Pair Difference'],
              shouldBeBlankOnInit: false,
              multiSelect: true,
              isClearable: true,
            },
