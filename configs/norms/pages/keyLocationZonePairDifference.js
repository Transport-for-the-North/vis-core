...
export const keyLocationZonePairDifference = {
      ...
      config: {
        ...
        filters: [
            ...
            { ...selectors.timePeriod, filterName: "Time Period 1", visualisations:['Zone Accessibility Pair Difference'],
              shouldBeBlankOnInit: false,
              multiSelect: true,
              isClearable: true,
            },
            { ...selectors.timePeriodTwo, filterName: "Time Period 2", visualisations:['Zone Accessibility Pair Difference'],
              shouldBeBlankOnInit: false,
              multiSelect: true,
              isClearable: true,
            },
