...
export const stationPairsSideBySide = {
    ...
    filters: [
        ...
        { ...selectors.scenarioFilter, filterName: "Left Scenario", visualisations: ['Station Pairs Side-by-Side'], actions: [{ action: "UPDATE_DUAL_QUERY_PARAMS" }] },
        ...
        { ...selectors.scenarioFilter, filterName: "Right Scenario", visualisations: ['Station Pairs Side-by-Side'], actions: [{ action: "UPDATE_DUAL_QUERY_PARAMS" }]},
