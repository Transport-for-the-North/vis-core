...
export const popEmpZoneTotalsDifference = {
      ...
      config: {
        ...
        filters: [
            ...
            { ...selectors.timePeriod, filterName: "Time Period 1", visualisations:['Landuse Accessibility Totals Difference'],
              shouldBeBlankOnInit: false,
              multiSelect: true,
              isClearable: true,
            },
            { ...selectors.timePeriodTwo, filterName: "Time Period 2", visualisations:['Landuse Accessibility Totals Difference'],
              shouldBeBlankOnInit: false,
              multiSelect: true,
              isClearable: true,
            },
