...
export const linkTotalsDifference = {
    ...
    config: {
      ...
      filters: [
        ...
        { ...selectors.scenarioFilter, filterName: "Scenario 1", paramName: "scenarioCodeDoMinimum", visualisations: ['Link Totals Difference'] },
        ...
        { ...selectors.scenarioFilter, filterName: "Scenario 2", paramName: "scenarioCodeDoSomething", visualisations: ['Link Totals Difference'] },
