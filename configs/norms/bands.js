export const bands = [
    {
        ...
        metric: [
            ...
            {
                name: "Excess Seating",
                values: [0,2000, 10000, 30000, 70000, 140000],
                differenceValues: [-140000, -70000, -30000, -10000, 0, 10000, 30000, 70000, 140000],
                colours: ["#8bd58a","#5ec963","#3fb14b","#2b8b37","#186326","#0c3c17"]
            },
        ]
    }, 
    {
