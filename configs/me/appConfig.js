...
export const appConfig = {
  ...
  introduction:
    ...
    It integrates the targets from the 
    <a href="https://www.transportforthenorth.com/reports/strategic-transport-plan-transforming-the-north-2024/" target="_blank">Strategic Transport Plan (STP)</a>,
    ...
    The overall approach to monitoring progress on delivering the STP is set out in the 
    <a href="https://url.de.m.mimecastprotect.com/s/X5DyC57mz9iMGZ5KiOh0Uk2Ibr?domain=transportforthenorth.com" target="_blank">Monitoring and Evaluation Strategy</a>  
    which complements the M&E dashboard. 
    ...
    <p>The M&E dashboard provides time series data, where appropriate,  for each of the STP targets,  including a baseline measurement for each. 
    The data sources for the metrics are a mix of open-source data, data from TfN’s in-house modelling (our 
    <a href="https://ournorth.transportforthenorth.com/analytical-framework" target="_blank">Analytical Framework</a>), 
    and commissioned data to measure progress. </p>
     `,
  methodology:"",
