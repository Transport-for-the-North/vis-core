import { stbConfig as defaultStbConfig } from "./stbConfig";
...
// Export the generated appConfig using the default stbConfig
export const appConfig = generateAppConfig(defaultStbConfig, baseAppConfig);