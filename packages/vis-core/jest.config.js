export default {
  ...
  moduleNameMapper: {
    ...
    '^@turf/turf$': '<rootDir>/src/test-mocks/turf.js',
    '^@mapbox/mapbox-gl-draw$': '<rootDir>/src/test-mocks/mapbox-gl-draw.js',
    '^@ookla/mapbox-gl-draw-rectangle$': '<rootDir>/src/test-mocks/mapbox-gl-draw-rectangle.js',
